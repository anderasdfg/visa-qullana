    ...
    if (success) {
        ...
        var responseHTML = `<main>
                            <div class="container">
                                ...
                                <div class="small">                                
                                    ...
                                    <p class="small">
                                        <p class="small"><b class="instruction">IMPORTANTE: Presione finalizar para concretar la transacci車n.</b></p> Esta tienda est芍 autorizada por Visa para realizar transacciones electr車nicas.
        ...
        if (transaction.statusCode == '403' || (transaction.error.errorCode == '400' && transaction.error.errorMessage == 'MERCHANT_ID does not match') ||(transaction.error.errorCode == '400' && transaction.error.errorMessage == 'AMOUNT does not match')) {
            content = `<div class="colums">
                        ...
                        <div class="left">
                            ...
                            <p>Su transacci車n no pudo ser realizada. </p>
                        </div>
                    </div>`
        } else {
            content = `<div class="colums">
        ...
        var responseHTML = `<main>
                            <div class="container">
                                ...
                                <a href="${config[env].return}" class="btnBlue" >Finalizar</a>
                                    <p class="small">
                                        <p class="small"><b class="instruction">IMPORTANTE: Presione finalizar para intentar nuevamente.</b></p> Esta tienda est芍 autorizada por Visa para realizar transacciones electr車nicas.
